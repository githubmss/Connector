...
{
    const BASE_MEDIA_PATH = 'magentomobileshop/dashboard/images';
    ...
    public function execute()
    {
        ...
        if (!$data) {
            $this->_redirect('magentomobileshop_connector/dashboard/adding');
            return;
        }
        try {
    ...
    {
        return $this->_authorization->isAllowed('Magentomobileshop_Connector::save');
